...
\begin{itemize}
	...
	\item \textbf{Controls ($\mathbf{X}$):}
	\begin{itemize}
		\item Age, income, family size, education, home ownership (\textit{hown}), arital status, two-earner household, defined benefit pension (\textit{db}), IRA participation (\textit{pira})
	\end{itemize}
